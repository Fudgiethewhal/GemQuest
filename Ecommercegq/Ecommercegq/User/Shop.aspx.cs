        ...
        void getAllProducts()
        {
            try 
            {
                using(con = new MySqlConnection(Utils.getConnection()))
                {
                    ...
                    cmd.Parameters.AddWithValue("in_ShortDescription", DBNull.Value);
                    cmd.Parameters.AddWithValue("in_LongDescription", DBNull.Value);
                    cmd.Parameters.AddWithValue("in_AdditionalDescription", DBNull.Value);
                    cmd.Parameters.AddWithValue("in_Price", DBNull.Value);
                    cmd.Parameters.AddWithValue("in_Quantity", DBNull.Value);
                    cmd.Parameters.AddWithValue("in_Size", DBNull.Value);
                    cmd.Parameters.AddWithValue("in_Color", DBNull.Value);
                    cmd.Parameters.AddWithValue("in_CompanyName", DBNull.Value);
                    cmd.Parameters.AddWithValue("in_CategoryId", DBNull.Value);
                    cmd.Parameters.AddWithValue("in_SubCategoryId", DBNull.Value);
                    cmd.Parameters.AddWithValue("in_IsCustomized", DBNull.Value);
                    cmd.Parameters.AddWithValue("in_IsActive", DBNull.Value);
                    cmd.Parameters.AddWithValue("in_ImageUrl", DBNull.Value);
